                ...
                <div class="row about-us-row row-cols-1 row-cols-md-3 g-4">
                    <div class="col">
                        <div class="card about-card h-100 text-center p-4">
                            <div className="icon fs-1"><i class="fa-brands fa-joomla"></i></div>
                            <div class="card-body">
                                <h5 class="card-title pb-2">SEO Consultancy</h5>
                                <p class="card-text fs-6">Delectus recteque has ne, no pro tation commodo. Ea libris utamur vix, in sumo augue soluta vis.</p>
                            </div>
                    ...
                    <div class="col">
                        <div class="card about-card h-100 text-center p-4">
                            <div className="icon fs-1"><i class="fa-solid fa-file-pen"></i></div>
                            <div class="card-body">
                                <h5 class="card-title pb-2">Competitor Analysis</h5>
                                <p class="card-text fs-6">Per ea quod iusto. Te autem perti nax definitiones vel, denique patrioque id per was be more.</p>
                            </div>
                    ...
                    <div class="col">
                        <div class="card about-card h-100 text-center p-4">
                            <div className="icon fs-1"><i class="fa-solid fa-desktop"></i></div>
                            <div class="card-body">
                                <h5 class="card-title pb-2">Social Media Marketing</h5>
                                <p class="card-text fs-6">Delenit signiferumque ei cum, te pertinax voluptatum sed, ornatus nonumes explicari sit et.</p>
                            </div>
            ...
            <div className="container">
                <div className="row d-flex align-items-center">
                    <div className="col-6">
                        ...
                        <p>Ad nec unum copiosae. Sea ex everti labores, ad option iuvaret qui muva.
